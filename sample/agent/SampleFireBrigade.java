 ...
 * SEU's Fire Brigade
 */
public class SampleFireBrigade extends SampleAgent<FireBrigade> {
	...
	protected void postConnect() {
		super.postConnect();
		worldmodel.indexClass(StandardEntityURN.BUILDING, StandardEntityURN.REFUGE);
	...
	public Building nextNearBuildingToExtinguish() {
		...
		if (extinguishableBuildings.isEmpty()) {
			...
			comperator = new BurningBuildingComparator(worldmodel, getTimeStep());
	...
	protected void processExtinguishFireTaskMessage(
		...
		Building targetBuilding = (Building) worldmodel.getEntity(targetBuildingID);
