...
public class RegionResignMessage extends Message {

	public RegionResignMessage() {
		super();
	}
	...
	public RegionResignMessage(EntityID id, int region) {
		this();
	...
	public MessageType getType() {
		return MessageType.RegionResignMessage;
	}
}
