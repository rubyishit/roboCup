 ...
 */
public final class StandardEntityFactory extends
		AbstractEntityFactory<StandardEntityURN> {
	/**
	...
	public StandardEntity makeEntity(StandardEntityURN urn, EntityID id) {
		...
		case BIRD_MAN:
			return new BirdMan(id);
		case AMBULANCE_TEAM:
			return new AmbulanceTeam(id);
		case POLICE_FORCE:
			return new PoliceForce(id);
		default:
			throw new IllegalArgumentException("Unrecognised entity urn: "
					+ urn);
		}
	}
}
